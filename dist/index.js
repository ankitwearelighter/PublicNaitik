                    ...
                    <react_native_1.View style={styles.paginationDots}>
                        {this.props.data.length > 1 &&
                            this.props.data.map((_, i) => this.props.dotClickEnabled ? (<react_native_1.TouchableOpacity key={i} style={[
                                ...
                                <react_native_1.View style={{ width: 6, height: 6, justifyContent: 'center', alignSelf: 'center', alignItems: 'center', backgroundColor: this._rtlSafeIndex(i) === this.state.activeIndex ? 'black' : 'grey', borderRadius: 3 }}>

                                </react_native_1.View>
                            </react_native_1.TouchableOpacity>) : (<react_native_1.View key={i} style={[
                                styles.dot,
                                this._rtlSafeIndex(i) === this.state.activeIndex
                                    ? this.props.activeDotStyle
                                    : this.props.dotStyle,
                            ]} >
                                <react_native_1.View style={{ width: 5, height: 5, backgroundColor: 'green' }}>
